...
export function createLandingPage() {
  ...
  text.innerText =
    "Welcome to Wishversum! Here you can make a wish and send it to the universe. We will make sure that your wish is fulfilled. You can also help others to fulfill their wishes. Just click on the button below and make a wish!";
  ...
  button.addEventListener("click", () => {
    ...
    saveData(); // Attach form submit event listener
  });
